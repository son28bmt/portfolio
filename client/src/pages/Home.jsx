    ...
    <div className="relative overflow-hidden pt-20 pb-20 md:pt-32 md:pb-40">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-base sm:text-lg md:text-xl text-white/60 max-w-2xl mb-12 px-6">
          Biến ý tưởng thành sản phẩm thực tế. Tôi tập trung tạo ra các giải pháp phần mềm hiệu quả, mượt mà và đầy cảm hứng.
        </p>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="flex flex-col sm:flex-row sm:flex-wrap justify-center gap-4 mb-20"
        >
          <Link
            to="/du-an"
        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 md:gap-8 px-4">
            {techStack.map((tech, index) => (
              ...
              >
                <div className="text-white/40 group-hover:text-primary transition-colors">{tech.icon}</div>
